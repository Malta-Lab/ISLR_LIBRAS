#!/bin/bash
# videomae on MINDS dataset, no pre-train on kinetics and no data augmentations, with 10 seeds from seeds.txt
...
do
    ...
    for dir in /mnt/G-SSD/BRACIS/BRACIS-2024/lightning_logs/base/videomae_no_augmentation_"${seed}"/version_*/checkpoints; do
    ...
    experiment_name="videomae_no_augmentations_${seed}"
