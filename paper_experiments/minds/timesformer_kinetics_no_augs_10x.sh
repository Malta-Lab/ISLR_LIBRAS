#!/bin/bash
# timesformer on MINDS dataset, pre-train on kinetics, no augs, with 10 seeds from seeds.txt
...
do
    ...
    for dir in /mnt/G-SSD/BRACIS/BRACIS-2024/lightning_logs/minds/no_pretrain/timesformer_kinetics_no_augmentation_"${seed}"/version_*/checkpoints; do
    ...
    experiment_name="timesformer_kinetics_no_augmentations_${seed}"
