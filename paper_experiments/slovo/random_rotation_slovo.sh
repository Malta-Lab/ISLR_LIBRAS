...
experiment_name="slovo_random_rotation_0.35_seed_$seed"
log_file="./logs/${experiment_name}.log"

echo "Running ${experiment_name} with seed $seed and random rotation 0.35" | tee -a "$log_file"

# Run the training script
CUDA_VISIBLE_DEVICES=2 python train_v3.py \
