#!/bin/bash
# videomae on MINDS dataset with single seed (42) and random rotation variations

# Define array of random rotation values (degrees)
random_rotation=("0.05" "0.1" "0.15" "0.2" "0.25" "0.3" "0.35" "0.4" "0.45" "0.5" "5" "10" "15" "20" "25" "30" "35" "40" "45" "50")
