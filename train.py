...
if __name__ == "__main__":    
    ...
    parser.add_argument('-ptm', '--pretrained_model', type=str, default="MCG-NJU/videomae-base")
    ...
    transforms = build_transforms(args.transforms.copy(),
                                resize_dims=(224, 224),
    ...
    root_dir=args.data_path,
    extensions=["pt"],
    transform=build_transforms(['normalize'],
                                resize_dims=(224, 224),
                                sample_frames=args.frames,
                                random_sample=False),
    split="test",
    ...
    # create model
    model = VideoModel(args.pretrained_model,
