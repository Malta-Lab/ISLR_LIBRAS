CUDA_VISIBLE_DEVICES=3,4 python train.py -ptm "MCG-NJU/videomae-base-finetuned-kinetics" --gpus 2 -sched "plateau" -lr 0.0001 --data_path "../MINDS_tensors_32" --exp_name "transforms_ablation_no_transform" -t "normalize" --frames 16 -bs 16

CUDA_VISIBLE_DEVICES=3,4 python train.py -ptm "MCG-NJU/videomae-base-finetuned-kinetics" --gpus 2 -sched "plateau" -lr 0.0001 --data_path "../MINDS_tensors_32" --exp_name "transforms_ablation_random_sample" -t "normalize" --random_sample --frames 16 -bs 16
