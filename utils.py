...
#     frames = frames.permute(3, 0, 1, 2)  # Convert from HWC to CHW per frame.
#     frames = frames.permute(1, 0, 2, 3)  # Now shape: [frames, channels, H, W]
#     frames = Resize((224, 224))(frames)
#     frames = Normalize((118.4939, 118.4997, 118.5007), (57.2457, 57.2454, 57.2461))(frames)
...
CLASSES2IDX = {
    ...
    'bala': 5, 'banco': 6, 'banheiro': 7, 'barulho': 8, 'cinco': 9,
    'conhecer': 10, 'espelho': 11, 'esquina': 12, 'filho': 13, 'maca': 14,
    'medo': 15, 'ruim': 16, 'sapo': 17, 'vacina': 18, 'vontade': 19
}
